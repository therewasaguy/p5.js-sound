...
const {midiToFreq, convertToWav, checkFileFormats} = Helpers;
...
p5.SoundFile = function(paths, onload, onerror, whileLoading) {
  if (typeof paths !== 'undefined') {
    if (typeof paths === 'string' || typeof paths[0] === 'string') {
      var path = checkFileFormats(paths);
      this.url = path;
    }
...
p5.SoundFile.prototype.reverseBuffer = function() {
  if (this.buffer) {
    var currentPos = this._lastPos / audiocontext.sampleRate;
...
p5.SoundFile.prototype.setBuffer = function(buf) {
  ...
  var newBuffer = audiocontext.createBuffer(numChannels, size, audiocontext.sampleRate);
...
var _createCounterBuffer = function(buffer) {
  ...
  const audioBuf = audiocontext.createBuffer( 1, buffer.length, audiocontext.sampleRate );
...
p5.SoundFile.prototype._initCounterNode = function() {
  var self = this;
  var now = audiocontext.currentTime;
  var cNode = audiocontext.createBufferSource();
  ...
  self._scopeNode = audiocontext.createScriptProcessor( 256, 1, 1 );
