'use strict';
import {audiocontext, meter, soundArray, input} from './master';
 ...
 *  </code></div>
 */
const Amplitude = function(smoothing) {
 ...
 *  </code></div>
 */
Amplitude.prototype.setInput = function(source, smoothing) {
...
Amplitude.prototype.connect = function(unit) {
  if (unit) {
    ...
    this.output.connect(this.panner.connect(input));
  }
};

Amplitude.prototype.disconnect = function() {
  if (this.output) {
...
Amplitude.prototype._audioProcess = function(event) {
 ...
 *  </code></div>
 */
Amplitude.prototype.getLevel = function(channel) {
...
Amplitude.prototype.dispose = function() {
