/*! p5.sound.js v0.2.17 2015-11-17 */
...
soundfile = function () {
   ...
   *    text('hover to fade in', width/2, height/2);
   *
   *    // fade to 0 over 1.2 seconds
   *    mySound.setVolume(0, 1.2);
   *  }
   *  </code></div>
   */
...
/** Tone.js module by Yotam Mann, MIT License 2014  http://opensource.org/licenses/MIT **/
var Tone_signal_ScaleExp;
Tone_signal_ScaleExp = function (Tone) {
...
}(Tone_core_Tone, Tone_signal_Scale);
var oscillator;
oscillator = function () {
  'use strict';
  var p5sound = master;
  ...
  var Mult = Tone_signal_Multiply;
  var Scale = Tone_signal_Scale;
  var ScaleExp = Tone_signal_ScaleExp;
  /**
...
}(master, Tone_signal_Signal, Tone_signal_Add, Tone_signal_Multiply, Tone_signal_Scale, Tone_signal_ScaleExp);
var env;
env = function () {
  'use strict';
  var p5sound = master;
