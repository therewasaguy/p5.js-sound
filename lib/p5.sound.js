...
Tone_core_Context = function (Tone) {
  ...
  return Tone.Context;
}(Tone_core_Tone, Tone_core_Emitter);
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
...
}(Tone_core_Tone, Tone_signal_Signal, Tone_signal_Expr, Tone_signal_EqualPowerGain, Tone_core_Gain);
var effect;
'use strict';
effect = function () {
  var p5sound = master;
...
Tone_core_Clock = function (Tone) {
  ...
  return Tone.Clock;
}(Tone_core_Tone, Tone_signal_TickSignal, Tone_core_TimelineState, Tone_core_Emitter);
var metro;
'use strict';
metro = function () {
  var p5sound = master;
