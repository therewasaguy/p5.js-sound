...
;
define("Tone/version", function(){});

/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_core_Tone;
Tone_core_Tone = function (version) {
  'use strict';
  var Tone = function () {
...
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_shim_OfflineAudioContext;
Tone_shim_OfflineAudioContext = function (Tone) {
  if (Tone.supported) {
...
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_shim_AudioContext;
Tone_shim_AudioContext = function (Tone) {
  if (Tone.supported) {
...
Tone_core_Context = function (Tone) {
  ...
  return Tone.Context;
}(Tone_core_Tone, Tone_core_Emitter, Tone_core_Timeline);
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_core_AudioNode;
Tone_core_AudioNode = function (Tone) {
...
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_shim_WaveShaperNode;
Tone_shim_WaveShaperNode = function (Tone) {
...
}(Tone_core_Tone, Tone_signal_SignalBase);
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
...
Tone_type_Time = function (Tone) {
  ...
  return Tone.Time;
}(Tone_core_Tone, Tone_type_TimeBase);
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
...
Tone_core_Param = function (Tone) {
  ...
  return Tone.Param;
}(Tone_core_Tone, Tone_type_Type, Tone_core_AudioNode);
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_core_OfflineContext;
Tone_core_OfflineContext = function (Tone) {
...
}(Tone_core_Tone, Tone_core_Context);
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_shim_BufferSourceNode;
Tone_shim_BufferSourceNode = function (Tone) {
  if (Tone.supported) {
    var ua = navigator.userAgent.toLowerCase();
...
Tone_core_Gain = function (Tone) {
  ...
  return Tone.Gain;
}(Tone_core_Tone, Tone_core_Param, Tone_type_Type);
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_shim_ConstantSourceNode;
Tone_shim_ConstantSourceNode = function (Tone) {
...
}(Tone_core_Tone, Tone_shim_AudioContext, Tone_shim_BufferSourceNode, Tone_core_Context);
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
...
Tone_signal_Signal = function (Tone) {
  ...
  return Tone.Signal;
}(Tone_core_Tone, Tone_signal_WaveShaper, Tone_type_Type, Tone_core_Param, Tone_shim_ConstantSourceNode);
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_signal_Add;
...
}(Tone_core_Tone, Tone_core_Param, Tone_core_Gain);
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
...
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_signal_TickSignal;
Tone_signal_TickSignal = function (Tone) {
...
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_source_TickSource;
Tone_source_TickSource = function (Tone) {
  'use strict';
...
}(Tone_core_Tone, Tone_signal_TickSignal, Tone_core_TimelineState, Tone_core_Timeline);
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_core_Clock;
Tone_core_Clock = function (Tone) {
  ...
  return Tone.Clock;
}(Tone_core_Tone, Tone_source_TickSource, Tone_core_TimelineState, Tone_core_Emitter);
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_core_IntervalTimeline;
Tone_core_IntervalTimeline = function (Tone) {
  'use strict';
...
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_core_TransportEvent;
Tone_core_TransportEvent = function (Tone) {
...
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_core_TransportRepeatEvent;
Tone_core_TransportRepeatEvent = function (Tone) {
...
}(Tone_core_Tone, Tone_core_TransportEvent);
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_core_Transport;
Tone_core_Transport = function (Tone) {
  'use strict';
...
}(Tone_core_Tone, Tone_core_Clock, Tone_type_Type, Tone_core_Timeline, Tone_core_Emitter, Tone_core_Gain, Tone_core_IntervalTimeline, Tone_core_TransportRepeatEvent);
/** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
var Tone_signal_TransportTimelineSignal;
Tone_signal_TransportTimelineSignal = function (Tone) {
...
}(Tone_core_Tone, Tone_core_Transport, Tone_signal_Signal);
var envelope;
'use strict';
envelope = function () {
  var p5sound = master;
  ...
  var Mult = Tone_signal_Multiply;
  var Scale = Tone_signal_Scale;
  var TimelineSignal = Tone_signal_TransportTimelineSignal;
  /**
...
}(master, Tone_signal_Add, Tone_signal_Multiply, Tone_signal_Scale, Tone_signal_TransportTimelineSignal);
var pulse;
'use strict';
pulse = function () {
  var p5sound = master;
...
}(Tone_core_Tone, Tone_signal_Signal, Tone_signal_Subtract, Tone_signal_EqualPowerGain, Tone_core_Gain);
var effect;
'use strict';
effect = function () {
  var p5sound = master;
...
}(master, Tone_signal_TransportTimelineSignal, helpers);
var distortion;
'use strict';
distortion = function () {
  var Effect = effect;
...
src_app = function () {
  var p5SOUND = master;
  return p5SOUND;
}(shims, audiocontext, master, helpers, errorHandler, panner, soundfile, amplitude, fft, oscillator, envelope, pulse, noise, audioin, filter, eq, panner3d, listener3d, delay, reverb, metro, looper, soundloop, compressor, soundRecorder, gain, monosynth, polysynth, distortion, audioVoice, monosynth, polysynth);
}));